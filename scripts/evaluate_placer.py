...
def main() -> None:
    ...
    if args.qp_only:
        ...
        print(
            f"proxy_before_Qp={pi:.6f}  proxy_after_Qp={po:.6f}  delta={dlt:+.2f}%  "
    ...
    print(
        ...
        f"delta_vs_initial before legalization={dlt_grad:+.2f}%  "
    ...
    if args.legalize_at_end:
        ...
        print(
            f"proxy_after_qp={dp_qp:.6f}  delta_vs_initial after legalization={dlt_qp:+.2f}%  "
